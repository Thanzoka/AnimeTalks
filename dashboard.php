...
<div id="main-container" class="container-fluid">
	...
	<p class="section-description">Adicione ou atualize as informações dos filmes/animes que você enviou</p>
	<div class="col-md-12" id="add-movie-container">
		<a href="<?= $BASE_URL ?>newmovie.php" class="btn card-btn"><i class="fas fa-plus"></i> Adicionar filme/anime</a>
	</div>
