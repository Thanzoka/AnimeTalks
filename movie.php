        ...
        <div class="offset-md-1 col-md-10" id="reviews-container">
            ...
            <?php if(!empty($userData) && !$userOwnsMovie && !$alreadyReviewed): ?>
                <div class="col-md-12" id="review-form-container">
                    ...
                    <p class="page-description">Preencha o formulário com a nota e comentário sobre o filme/anime</p>
                    <form action="<?= $BASE_URL ?>review_process.php" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="review" name="review" rows="3" placeholder="O que você achou do filme/anime?"></textarea>
                        </div>
            ...
            <?php if(empty($movieReviews)): ?>
                <p class="empty-list">Ainda não há comentários para este filme/anime.</p>
            <?php endif; ?>
        </div>
    </div>
</div>
