...
class MovieDAO implements MovieDAOInterface {
    ...
    public function create(Movie $movie) {
        ...
        $this->message->setMessage("Filme/Anime adicionado com sucesso!", "success", "index.php");
    ...
    public function update(Movie $movie) {
        ...
        $this->message->setMessage("Filme/Anime atualizado com sucesso!", "success", "dashboard.php");
    ...
    public function destroy($id) {
        ...
        $this->message->setMessage("Filme/Anime removido com sucesso!", "success", "dashboard.php");
